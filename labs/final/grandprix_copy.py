...
### State Update ###
def update():
    global curState, arColorGlobal, counter, wallfollow, orange_pillar_end, speed
...
def update_contour2(color, image):
    """
    Finds contours in the current color image and uses them to update contour_center
    and contour_area
    """
...
def newCanyon():#arColor):
    ...
    update_contour2(ORANGELINE, image)
    if contour_center is None:
        update_contour2(PURPLELINE, image)
